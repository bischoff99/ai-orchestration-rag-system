#!/usr/bin/env python3
"""
Deploy Clean n8n Workflows
Creates workflows with only required fields for n8n API
"""
...
def create_simple_rag_query_workflow():
    """Create a simple RAG Query workflow"""
    return {
...
def create_simple_document_ingestion_workflow():
    """Create a simple Document Ingestion workflow"""
    return {
...
def create_simple_production_workflow():
    """Create a simple Production RAG workflow"""
    return {
...
def main():
    ...
    print("🚀 Deploying Clean n8n Workflows")
    print("=" * 40)
    ...
    workflows = [
        create_simple_rag_query_workflow(),
        create_simple_document_ingestion_workflow(),
        create_simple_production_workflow()
    ]
